...
const {getDashboardStats ,getCompanySummary ,getNewEmployees ,getEmployeesByLeaveType ,getCompanyLeavePolicy  ,getBranchesDetails ,getBranchesWithDepartments ,getEmployeesSummary ,getContractsSummary} =require('../controllers/adminDashboardController');
